...
$txtcategoria = strtoupper($_POST['txtcategoria']);
    ...
    <script type="text/javascript">
        ...
        limpiarsubtipoactivo();
    </script>
    <?php

    $rsdatos = "select count(*) total FROM subtipoactivos where descripcionsta = '$txtcategoria'";
    ...
    if ($total == '0') {
$rsinsertar = "INSERT INTO subtipoactivos (descripcionsta) VALUES
      ('$txtcategoria')";
