...
<script src="../js/reportesingresos.js" type="text/javascript"></script> 
<script>
...
<div class="row mt">
    ...
    <h4 class="mb"><i class="fa fa-angle-right"></i> Reporte de Ingresos de Equipos</h4>
            ...
            <div class="col-sm-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        ...
                        <button type="button" onclick="reporteconsultaringresos()" class="btn btn-theme" style="cursor:pointer;">  <i class="glyphicon glyphicon-saved"></i> Buscar</button>
                    </div>
