...
<div class="row mt">
    <div class="col-lg-12">
        <div class="form-panel">
            <h4 class="mb"><i class="fa fa-angle-right"></i> Nueva Marca</h4>
            ...
            <form class="form-horizontal style-form">
                <div class="form-group">
                   ...
                   <div class="form-group">
                    <label class="col-sm-1 col-sm-1 control-label">Modelo</label>
                    <div class="col-sm-11">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <button type="button" onclick="guardarmarca()" class="btn btn-theme"> <i class="glyphicon glyphicon-save-file"></i> Guardar</button>
                        <button type="button" onclick="frmmarca()" class="btn btn-danger"><i class="glyphicon glyphicon-send"></i> Listar Marca</button>
                    </div>
