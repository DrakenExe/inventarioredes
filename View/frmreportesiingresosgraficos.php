...
<script>
    function reporteingresosdiagrafico() {
        ...
        else
        {
            ...
            $.post("../Model/reporteingresosgrafico.php",
                    {
...
<div class="row mt">
    ...
    <h4 class="mb"><i class="fa fa-angle-right"></i> Reporte de Ingresos por día</h4>
            ...
            <div class="col-sm-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        ...
                        <button type="button" onclick="reporteingresosdiagrafico()" class="btn btn-theme" style="cursor:pointer;">  <i class="glyphicon glyphicon-saved"></i> Buscar</button>
                    </div>
