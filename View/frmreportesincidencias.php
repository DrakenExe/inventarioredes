...
<script src="../js/reportesincidencias.js" type="text/javascript"></script> 
            ...
            <div class="col-sm-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        ...
                        <button type="button" onclick="reporteconsultarincidencias()" class="btn btn-theme" style="cursor:pointer;">  <i class="glyphicon glyphicon-saved"></i> Buscar</button>
                    </div>
